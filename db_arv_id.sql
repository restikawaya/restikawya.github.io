...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Nov 2022 pada 10.14
...
-- Database: `db_arv.id`
--
CREATE DATABASE IF NOT EXISTS `db_arv.id` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_arv.id`;
...
(13, '16U2xcLOuknEA', 1, '2022-11-20 08:52:12', 'Cart');
...
(1, 1, 'baju1', 'produk/baju1.jpg', 'baju warna warni', 5, 23000, 19000, '2019-12-20 16:10:26'),
(2, 1, 'baju2 ', 'produk/baju2.jpg', 'baju warna warni', 4, 24000, 19500, '2019-12-20 16:24:13'),
(3, 3, 'baju3', 'produk/baju3.jpg', 'baju warna warni', 5, 25000, 15000, '2020-03-16 19:16:53');
